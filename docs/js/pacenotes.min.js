...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var RouteData = __webpack_require__(1);
	var GraphData = __webpack_require__(7);

	var CueSheetView = __webpack_require__(39);
	var ProfileView = __webpack_require__(43);
	...
	// initialize view
	var cueSheetView = new CueSheetView({
	  routeData: routeData
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MarkerIcon = __webpack_require__(4);
	var WayPointData = __webpack_require__(5);
	var LineData = __webpack_require__(6);
	...
	var RouteData = function () {
	  ...
	  _createClass(RouteData, [{
	    ...
	    key: 'setUserLocation',
	    value: function setUserLocation(lngLat) {
	    ...
	    key: '_createDistanceList',
	    value: function _createDistanceList(lngLat) {
	      var _this = this;

	      this.distanceList.splice(0, this.distanceList.length);
	      this.wayPointList.forEach(function (wayPoint, index) {
	        var distance = LineData.distance(wayPoint.lngLat, lngLat);
	    ...
	    key: '_calculateClosestIndex',
	    value: function _calculateClosestIndex(lngLat) {
	      var minDistance = 20000000;
	      var minIndex = -1;
	      this.lineList.forEach(function (line, lineIndex) {
	        line.line.reduce(function (startPoint, endPoint) {
	          ...
	          var lineDirection = LineData.getDirectionValue(startPoint, endPoint);
	          var userDirection = LineData.getDirectionValue(startPoint, lngLat);
	          var direction = Math.abs(lineDirection - userDirection);
	          if (direction > 180.0) {
	            direction = Math.abs(direction - 360.0);
	          }
	          if (direction <= 90.0) {
	            var radian = direction * Math.PI / 180.0;
	            var lineDistance = LineData.distance(startPoint, endPoint);
	            var userDistance = LineData.distance(startPoint, lngLat);
	            var userDistanceOnLine = userDistance * Math.cos(radian);
	            if (userDistanceOnLine < lineDistance) {
	              var userDistanceFromLine = userDistance * Math.sin(radian);
	    ...
	    value: function toJSON() {
	      return {
	        ...
	        wayPoint: this.data.wayPointList.map(function (wayPoint) {
	          return wayPoint.toJSON();
	        }),
	        route: this.data.lineList.map(function (line) {
	          return line.toJSON();
	        }),
	        statistics: {
	    ...
	    key: '_fixWayPoint',
	    value: function _fixWayPoint() {
	      this._fixWayPointDistance();
	      this._fixWayPointStaticMap();
	    }
	  }, {
	    key: '_fixWayPointDistance',
	    value: function _fixWayPointDistance() {
	      var _this3 = this;
	      ...
	      var interval = 0;
	      var intervalCP = 0;
	      this.lineList.forEach(function (line, index) {
	        distance += line.distance;
	        interval += line.distance;
	        intervalCP += line.distance;
	        _this3.wayPointList[index + 1].distance = distance;
	        _this3.wayPointList[index + 1].interval = interval;
	        _this3.wayPointList[index + 1].intervalCP = intervalCP;

	        if (_this3.wayPointList[index + 1].icon >= MarkerIcon.CUE_POINT) {
	          interval = 0;
	        }

	        if (_this3.wayPointList[index + 1].icon >= MarkerIcon.CHECKPOINT) {
	          intervalCP = 0;
	        }
	      });
	    }
	  }, {
	    key: '_fixWayPointStaticMap',
	    value: function _fixWayPointStaticMap() {
	      var _this4 = this;

	      this.wayPointList.forEach(function (wayPoint, index) {
	        wayPoint.staticMapLine = _this4._staticMapLine(index);
	      });
	    }
	  }, {
	    key: '_staticMapLine',
	    value: function _staticMapLine(wayPointIndex) {
	      var center = this.wayPointList[wayPointIndex].lngLat;
	      var staticLine = [];

	      var outsidePoint = null;
	      for (var lineIndex = wayPointIndex - 1; lineIndex >= 0; lineIndex--) {
	        var outside = this.lineList[lineIndex].line.slice().reverse().some(function (linePoint) {
	      ...
	      if (outsidePoint !== null) {
	        var radiusPoint = this._getRadiusPoint(staticLine[0], outsidePoint, center);
	        staticLine.splice(0, 0, radiusPoint);
	      }

	      outsidePoint = null;
	      for (var _lineIndex = wayPointIndex; _lineIndex < this.lineList.length; _lineIndex++) {
	        var _outside = this.lineList[_lineIndex].line.some(function (linePoint) {
	          if (LineData.distance(center, linePoint) > RouteData.STATIC_LINE_RADIUS) {
	            outsidePoint = linePoint;
	            return true;
	          }
	      ...
	      if (outsidePoint !== null) {
	        var _radiusPoint = this._getRadiusPoint(staticLine[staticLine.length - 1], outsidePoint, center);
	        staticLine.push(_radiusPoint);
	      }
	    ...
	    key: '_getRadiusPoint',
	    value: function _getRadiusPoint(insidePoint, outsidePoint, center) {
	      var insideDistance = LineData.distance(insidePoint, center);
	      var outsideDistance = LineData.distance(outsidePoint, center);

	      var a = RouteData.STATIC_LINE_RADIUS - insideDistance;
	      var b = outsideDistance - RouteData.STATIC_LINE_RADIUS;

	      return [(a * outsidePoint[0] + b * insidePoint[0]) / (a + b), (a * outsidePoint[1] + b * insidePoint[1]) / (a + b)];
	    }
	  }, {
	    key: 'store',
	    value: function store() {
	      var storeData = this.toJSON();
	    ...
	    value: function restore() {
	      var storage = new LocalStorage();
	      var data = storage.read('route_data');
	      if (data === null) {
	        return;
	      }
	    ...
	    set: function set(val) {
	      this.data.selectedIndex = val;
	    }
	  }, {
	    key: 'closestDistance',
	    get: function get() {
	      return this.data.closestDistance;
	    },
	    set: function set(val) {
	      this.data.closestDistance = val;
	    }
	  }, {
	    key: 'distanceList',
	    get: function get() {
	      return this.data.distanceList;
	    },
	    set: function set(val) {
	      this.data.distanceList = val;
	    }
	  }, {
	    key: 'userLocation',
	    get: function get() {
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var LZString = __webpack_require__(3);
	...
	var LocalStorageModel = function () {
	  ...
	  _createClass(LocalStorageModel, [{
	    key: 'isExistKey',
	    value: function isExistKey(key) {
	      return Object.keys(localStorage).some(function (storageKey) {
	    ...
	    value: function read(key) {
	      if (this.isExistKey(key)) {
	        var jsonString = LZString.decompress(localStorage.getItem(key));
...
/***/ (function(module, exports) {
	...
	MarkerIcon.POINT = 0;
	MarkerIcon.CUE_POINT = 1;
	MarkerIcon.CHECKPOINT = 2;
	MarkerIcon.START = 3;
	MarkerIcon.GOAL = 4;
	MarkerIcon.PIN = 5;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WayPointData = function () {
	  function WayPointData(options) {
	    _classCallCheck(this, WayPointData);
	  ...
	  _createClass(WayPointData, [{
	    ...
	    value: function readJSON(json) {
	      ...
	      var readOptions = [{ numeric: false, key: 'point', set: 'setPoint' }, { numeric: true, key: 'icon', set: 'icon' }, { numeric: false, key: 'name', set: 'setName' }, { numeric: false, key: 'comment', set: 'comment' }, { numeric: true, key: 'turn', set: 'turn' }, { numeric: true, key: 'altitude', set: 'altitude' }, { numeric: false, key: 'staticMapImage', set: 'staticMapImage' }];

	      return readOptions.every(function (option) {
	        ...
	        try {
	          _this2[option.set] = json[option.key];
	        } catch (e) {
	    ...
	    key: "point",
	    get: function get() {
	      return this.data.lngLat;
	    },
	    set: function set(val) {
	      this.data.lngLat = val;
	    }
	  }, {
	    key: "lngLat",
	    get: function get() {
	    ...
	    key: "intervalCP",
	    get: function get() {
	      return this.data.intervalCP;
	    },
	    set: function set(val) {
	      this.data.intervalCP = val;
	    }
	  }, {
	    key: "altitude",
	    get: function get() {
	    ...
	    set: function set(val) {
	      this.data.altitude = val;
	    }
	  }, {
	    key: "staticMapImage",
	    get: function get() {
	      return this.data.staticMapImage;
	    },
	    set: function set(val) {
	      this.data.staticMapImage = val;
	    }
	  }, {
	    key: "staticMapLine",
	    get: function get() {
	      return this.data.staticMapLine;
	    },
	    set: function set(val) {
	      this.data.staticMapLine = val;
	    }
	  }, {
	    key: "uniqueIndex",
	    get: function get() {
	      return this.data.uniqueIndex;
	    }
	  }, {
	    key: "setPoint",
	  ...
	  _createClass(LineData, [{
	    ...
	    value: function toJSON() {
	      ...
	      return {
	        ...
	        distance: this.distance,
	        line: this.line.map(function (point, index) {
	          return {
	            point: {
	              lng: point[0],
	              lat: point[1]
	            },
	            altitude: _this2.altitude[index]
	          };
	        })
	      };
	    }
	    ...
	    value: function readJSON(json) {
	      ...
	      var readOptions = [{ numeric: true, key: 'lineMode', set: 'lineMode' }, { numeric: false, key: 'ref', set: 'ref' }, { numeric: false, key: 'name', set: 'name' }, { numeric: false, key: 'zero', set: 'zero' }, { numeric: true, key: 'type', set: 'type' }, { numeric: true, key: 'distance', set: 'distance' }, { numeric: false, key: 'line', set: 'setLine' }];
	      ...
	      return readOptions.every(function (option) {
	        ...
	        try {
	          _this3[option.set] = json[option.key];
	        } catch (e) {
	    ...
	    value: function _getDirection() {
	      var lineLength = this.data.line.length;
	      if (lineLength < 2) {
	        return;
	      }
	    ...
	    key: "lastPoint",
	    get: function get() {
	      return this.data.line[this.data.line.length - 1];
	    }
	  }, {
	    key: "lineMode",
	    get: function get() {
	      return this.data.lineMode;
	    },
	    set: function set(val) {
	      this.data.lineMode = val;
	    }
	  }, {
	    key: "altitude",
	    get: function get() {
	    ...
	    key: "directionStart",
	    get: function get() {
	      return this.data.direction.start;
	    },
	    set: function set(val) {
	      this.data.direction.start = val;
	    }
	  }, {
	    key: "directionEnd",
	    get: function get() {
	      return this.data.direction.end;
	    },
	    set: function set(val) {
	      this.data.direction.end = val;
	    }
	  }, {
	    key: "directionName",
	    get: function get() {
	      return this.data.direction.name;
	    },
	    set: function set(val) {
	      this.data.direction.name = val;
	    }
	  }, {
	    key: "distance",
	    get: function get() {
	    ...
	    key: "setLine",
	    set: function set(json) {
	      if (json.every(function (element) {
	        ...
	        return !(typeof element.point.lng !== "number" || typeof element.point.lat !== "number" || typeof element.altitude !== "number");
	      }) === false) {
	        throw "json data is invalid";
	      }

	      this.data.line = json.map(function (element) {
	        return [element.point.lng, element.point.lat];
	      });
	      this.data.altitude = json.map(function (element) {
	        return element.altitude;
	      });
	    ...
	    value: function getDirectionValue(from, to) {
	      var x = to[0] - from[0];
	      var y = to[1] - from[1];
	      var dir = Math.acos(x / Math.sqrt(x * x + y * y)) / Math.PI * 180;
	    ...
	    value: function getDirectionString(direction) {
	      switch (true) {
	        case direction < 22.5:
	          return "E";
	        case direction < 67.5:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphData = function () {
	  function GraphData(options) {
	    ...
	    this._graphData = new Graph.Collection([this.lineData, this.cpData]);
	  ...
	  _createClass(GraphData, [{
	    key: '_createProfileData',
	    value: function _createProfileData() {
	      var profileData = this._graphData.at(0);
	      profileData.clear();

	      var lineList = this._routeData.lineList;
	      ...
	      lineList.forEach(function (line) {
	        line.line.reduce(function (previous, current, index) {
	      ...
	      profileData.smooth(GraphData.SMOOTHING_INTERVAL, GraphData.SMOOTHING_RANGE, GraphData.METER_PER_KILO, GraphData.LOCAL_MIN_MAX_THRESHOLD);
	    }
	  }, {
	    key: '_createCPData',
	    value: function _createCPData() {
	      var cpData = this._graphData.at(1);
	      cpData.clear();
	      ...
	      var wayPointList = this._routeData.wayPointList;
	      wayPointList.forEach(function (point, index) {
	        if (index === 0 || index === wayPointList.length - 1 || point.icon === MarkerIcon.CHECKPOINT) {
	          cpData.addPoint(new Graph.Point(point.distance / GraphData.METER_PER_KILO, point.altitude), GraphData.CP_COLOR, Graph.PointData.SHAPE.SQUARE);
	        }
	      });
	    }
	  }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Graph = {
	  ...
	  LineData: __webpack_require__(16),
	  PointData: __webpack_require__(18),
	  Point: __webpack_require__(17),
	  GraphView: __webpack_require__(19)
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  GraphData = __webpack_require__(15);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  GraphPoint = __webpack_require__(17);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  XAxisView = __webpack_require__(20);

	  YAxisView = __webpack_require__(23);

	  GraphCanvasView = __webpack_require__(24);

	  GraphPointView = __webpack_require__(26);

	  ScaleChangeView = __webpack_require__(27);

	  RangeView = __webpack_require__(30);

	  GestureView = __webpack_require__(31);

	  ScaleData = __webpack_require__(32);

	  OffsetData = __webpack_require__(33);

	  RangeData = __webpack_require__(34);

	  AxisData = __webpack_require__(35);

	  RectRegion = __webpack_require__(36);

	  GestureData = __webpack_require__(37);

	  GestureDataCollection = __webpack_require__(38);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  CanvasView = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  HiddenView = __webpack_require__(22);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  GraphLineView = __webpack_require__(25);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  GraphPointData = __webpack_require__(18);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  ScaleButtonView = __webpack_require__(28);

	  ScaleNumberView = __webpack_require__(29);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var FileSelectView = __webpack_require__(41);
	var GeoLocationModel = __webpack_require__(42);

	var CueSheetView = function () {
	  function CueSheetView(options) {
	    var _this = this;

	    _classCallCheck(this, CueSheetView);
	    ...
	    this.CueSheetView = new Vue({
	      ...
	      methods: {
	        importData: function importData() {
	          new FileSelectView().show().then(function (fileList) {
	            var fileReader = new FileReader();
	            fileReader.onload = function (e) {
	              _this.routeData.deleteData();
	              _this.routeData.readJSON(JSON.parse(e.target.result));
	              _this.routeData.store();
	              _this.frame.name = "cue";
	            };
	        ...
	        toImport: function toImport() {
	          setTimeout(function () {
	            _this.frame.name = "import";
	          }, 0);
	        },
	        toProfile: function toProfile() {
	          setTimeout(function () {
	            _this.frame.name = "profile";
	          }, 0);
	        },
	        currentCUE: function currentCUE() {
	          GeoLocationModel.getUserLocation().then(function (lngLat) {
	            _this.routeData.setUserLocation(lngLat);
	          }, function (error) {
	            alert(error.message);
	          });
	        },
	        mouseDown: function mouseDown(event) {
	          ...
	          _this.mouseDownTime = setTimeout(function () {
	        ...
	        mouseUp: function mouseUp(event) {
	          ...
	          var right = $(event.target).width() / 2 > event.changedTouches[0].clientX;
	          if (_this.mouseDownTime !== 0) {
	            clearTimeout(_this.mouseDownTime);
	            if (right) {
	              _this.routeData.previousCUE();
	            } else {
	              _this.routeData.nextCUE();
	            }
	          } else {
	            if (right) {
	              _this.routeData.previousCP();
	            } else {
	              _this.routeData.nextCP();
	            }
	          }
	          _this.mouseDownTime = 0;
	        },
	        previousCP: function previousCP() {
	          _this.routeData.previousCP();
	        },
	        previousCUE: function previousCUE() {
	          _this.routeData.previousCUE();
	        },
	        nextCUE: function nextCUE() {
	          _this.routeData.nextCUE();
	        },
	        nextCP: function nextCP() {
	          _this.routeData.nextCP();
	        },
	        staticMapCircleX: function staticMapCircleX(index) {
	          var center = _this.routeData.wayPointList[index].lngLat;
	          var centerX = _this.lngToTile(center[0]);
	          var staticLine = _this.routeData.wayPointList[index].staticMapLine;
	          if (staticLine.length === 0) {
	            return CueSheetView.MAP_SIZE / 2;
	          }
	          return _this.lngToDrawOffset(staticLine[0][0], centerX);
	        },
	        staticMapCircleY: function staticMapCircleY(index) {
	          var center = _this.routeData.wayPointList[index].lngLat;
	          var centerY = _this.latToTile(center[1]);
	          var staticLine = _this.routeData.wayPointList[index].staticMapLine;
	          if (staticLine.length === 0) {
	            return CueSheetView.MAP_SIZE / 2;
	          }
	          return _this.latToDrawOffset(staticLine[0][1], centerY);
	        },
	        staticMapLine: function staticMapLine(index) {
	          var center = _this.routeData.wayPointList[index].lngLat;
	          var centerX = _this.lngToTile(center[0]);
	          var centerY = _this.latToTile(center[1]);
	          var staticLine = _this.routeData.wayPointList[index].staticMapLine;

	          return staticLine.map(function (linePoint, lineIndex) {
	            var x = _this.lngToDrawOffset(linePoint[0], centerX);
	            var y = _this.latToDrawOffset(linePoint[1], centerY);
	        ...
	        staticMapArrow: function staticMapArrow(index) {
	          var staticLine = _this.routeData.wayPointList[index].staticMapLine;
	          ...
	          var centerX = _this.lngToTile(center[0]);
	          var centerY = _this.latToTile(center[1]);
	          var radian = -_this.getDirectionValue(staticLine[staticLine.length - 2], staticLine[staticLine.length - 1]) * Math.PI / 180.0;
	          var x = _this.lngToDrawOffset(staticLine[staticLine.length - 1][0], centerX);
	          var y = _this.latToDrawOffset(staticLine[staticLine.length - 1][1], centerY);

	          var x1 = CueSheetView.ARROW_SIZE / Math.sqrt(2);
	          var y1 = 0;
	          var x2 = -5;
	          var y2 = CueSheetView.ARROW_SIZE / 2;
	          var x3 = -5;
	          var y3 = -CueSheetView.ARROW_SIZE / 2;

	          return [["M", _this.rotateX(x1, y1, radian) + x, _this.rotateY(x1, y1, radian) + y].join(" "), ["L", _this.rotateX(x2, y2, radian) + x, _this.rotateY(x2, y2, radian) + y].join(" "), ["L", _this.rotateX(x3, y3, radian) + x, _this.rotateY(x3, y3, radian) + y].join(" ")].join(" ");
	        },
	        userLocationCircleX: function userLocationCircleX(index) {
	          var center = _this.routeData.wayPointList[index].lngLat;
	          var centerX = _this.lngToTile(center[0]);
	          if (_this.routeData.userLocation.length === 0) {
	            return CueSheetView.MAP_SIZE / 2;
	          }
	          return _this.lngToDrawOffset(_this.routeData.userLocation[0], centerX);
	        },
	        userLocationCircleY: function userLocationCircleY(index) {
	          var center = _this.routeData.wayPointList[index].lngLat;
	          var centerY = _this.latToTile(center[1]);
	          if (_this.routeData.userLocation.length === 0) {
	            return CueSheetView.MAP_SIZE / 2;
	          }
	          return _this.latToDrawOffset(_this.routeData.userLocation[1], centerY);
	        },
	        userLocationDirection: function userLocationDirection(index) {
	          if (_this.routeData.distanceList.length <= index) {
	            return "";
	          }

	          var radian = -_this.routeData.distanceList[index].direction * Math.PI / 180.0;
	          var x = _this.rotateX(CueSheetView.MAP_SIZE / 2 - 50, 0, radian) + CueSheetView.MAP_SIZE / 2;
	          var y = _this.rotateY(CueSheetView.MAP_SIZE / 2 - 50, 0, radian) + CueSheetView.MAP_SIZE / 2;

	          var x1 = CueSheetView.DIRECTION_SIZE / Math.sqrt(2);
	          var y1 = 0;
	          var x2 = 0;
	          var y2 = CueSheetView.DIRECTION_SIZE / 2;
	          var x3 = 0;
	          var y3 = -CueSheetView.DIRECTION_SIZE / 2;

	          return [["M", _this.rotateX(x1, y1, radian) + x, _this.rotateY(x1, y1, radian) + y].join(" "), ["L", _this.rotateX(x2, y2, radian) + x, _this.rotateY(x2, y2, radian) + y].join(" "), ["L", _this.rotateX(x3, y3, radian) + x, _this.rotateY(x3, y3, radian) + y].join(" ")].join(" ");
	        },
	        userLocationDirectionTextX: function userLocationDirectionTextX(index) {
	          if (_this.routeData.distanceList.length <= index) {
	            return 0;
	          }

	          var radian = -_this.routeData.distanceList[index].direction * Math.PI / 180.0;
	          return _this.rotateX(CueSheetView.MAP_SIZE / 2 - 50, 0, radian) + CueSheetView.MAP_SIZE / 2 - 20;
	        },
	        userLocationDirectionTextY: function userLocationDirectionTextY(index) {
	          if (_this.routeData.distanceList.length <= index) {
	            return 0;
	          }

	          var radian = -_this.routeData.distanceList[index].direction * Math.PI / 180.0;
	          return _this.rotateY(CueSheetView.MAP_SIZE / 2 - 50, 0, radian) + CueSheetView.MAP_SIZE / 2 + 25;
	        }
	      }
	    });
	  }

	  _createClass(CueSheetView, [{
	    key: 'lngToTile',
	    value: function lngToTile(lng) {
	      return (lng + 180.0) / 360.0 * Math.pow(2, CueSheetView.ZOOM + 1);
	    }
	  }, {
	    key: 'latToTile',
	    value: function latToTile(lat) {
	      return (1.0 - Math.log(Math.tan(lat * Math.PI / 180.0) + 1.0 / Math.cos(lat * Math.PI / 180.0)) / Math.PI) / 2 * Math.pow(2, CueSheetView.ZOOM + 1);
	    }
	  }, {
	    key: 'lngToDrawOffset',
	    value: function lngToDrawOffset(lng, centerX) {
	      return Math.floor(CueSheetView.MAP_SIZE / 2 - CueSheetView.TILE_SIZE * (centerX - this.lngToTile(lng)));
	    }
	  }, {
	    key: 'latToDrawOffset',
	    value: function latToDrawOffset(lat, centerY) {
	      return Math.floor(CueSheetView.MAP_SIZE / 2 - CueSheetView.TILE_SIZE * (centerY - this.latToTile(lat)));
	    }
	  }, {
	    key: 'rotateX',
	    value: function rotateX(x, y, radian) {
	      return x * Math.cos(radian) + y * Math.sin(radian);
	    }
	  }, {
	    key: 'rotateY',
	    value: function rotateY(x, y, radian) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(40), __webpack_require__(12)))
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var fileSelectView = function () {
	  function fileSelectView() {
	    var _this = this;

	    _classCallCheck(this, fileSelectView);
	  ...
	  _createClass(fileSelectView, [{
	    ...
	    value: function show() {
	      ...
	      var fileSelectElement = document.getElementById("file_select_input");
...
/***/ (function(module, exports) {
	 ...
	 */
	var GeoLocationModel = function () {
	  function GeoLocationModel() {
	    _classCallCheck(this, GeoLocationModel);
	  }

	  _createClass(GeoLocationModel, null, [{
	    key: "getUserLocation",
	    value: function getUserLocation() {
	      return new Promise(function (resolve, reject) {
	        if (navigator.geolocation) {
	          navigator.geolocation.getCurrentPosition(function (location) {
	            var lngLat = [location.coords.longitude, location.coords.latitude];
	            resolve(lngLat);
	          }, function (error) {
	            reject(error);
	          }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProfileView = function ProfileView(options) {
	  _classCallCheck(this, ProfileView);

	  var profile = document.getElementById("cue_sheet");
